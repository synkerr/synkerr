			...
			<div className="Body">
				<div className="position relative">
					...
					>
						<div className="container mx-auto px-4 sm:px-6 md:px-8">
							<div className="flex flex-col md:flex-row justify-between items-center">
								...
								/>
								<div className="flex flex-col sm:flex-row sm:items-center sm:justify-center sm:justify-between w-full md:w-1/2 text-sm sm:text-base rounded-full mt-4 md:mt-0">
									{" "}
									<h3 className="text-gray-400 mb-2 sm:mb-0 mr-4 font-bold">
										Our Aim
									</h3>
									<h3
										className="text-gray-400 cursor-pointer mb-2 sm:mb-0 mr-4"
					...
					<div className="container mx-auto px-4 sm:px-6 md:px-8 mt-10 sm:mt-16 md:mt-20">
						...
						>
							<p className="text-[#A9A9A9] text-xl sm:text-2xl md:text-4xl mb-2 sm:mb-4">
								Exploit the power of
							</p>
							<p className="text-white mb-2 sm:mb-4 text-2xl sm:text-3xl md:text-5xl">
								Purposful Connections
							</p>
							...
							<div className="mb-2 sm:mb-4">
								🎉 <span className="text-yellow-500"> BETA</span> version
								Dropping Soon
							</div>
							<div
				...
				<img
					...
					className="hidden sm:flex absolute bottom-0 left-0 h-[20%] w-[10%] sm:h-[25%] sm:w-[15%] md:h-[30%] md:w-[20%]"
